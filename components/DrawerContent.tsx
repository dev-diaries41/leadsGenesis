...
const DrawerContent = (props: any) => {
    ...
    return(
        <View style={{flex:1, backgroundColor:isDark? themes.dark.containerBackground:themes.light.containerBackground}}>
                ...
                <View style={[styles.drawerContent]}>
                    <View style={styles.userInfoSection}>
                        ...
                        <Image
                            ...
                            height:50,
                            borderRadius:25}}
                            tintColor={themes.dark.primaryColor}
                        />
                            <View style={{marginLeft:15, flexDirection:'column'}}>
                                <Text style={[styles.title, {color:isDark? themes.dark.textColor:themes.light.textColor}]}>John Doe</Text>
                                <Text style={[styles.caption, {color:isDark? themes.dark.textColor:themes.light.textColor}]}>@j_doe</Text>
                            </View>
                        </View>
                    ...
                    <DrawerItem 
                            ...
                            label="Home"
                            labelStyle={{fontFamily:'monserrat-bold', color:isDark? themes.dark.textColor:themes.light.textColor}}
...
const styles = StyleSheet.create({
    ...
    bottomDrawerSection: {
        ...
        borderTopColor: themes.dark.primaryColor,
        // borderTopWidth: 1
    },
    preference: {
      flexDirection: 'row',
